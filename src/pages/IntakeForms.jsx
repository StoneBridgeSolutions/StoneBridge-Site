    ...
    <div className="bg-navy min-h-screen pt-20 flex flex-col">
      <section className="grain-overlay relative flex-1 flex items-center justify-center px-6 py-24 overflow-hidden">
        ...
        <div className="relative z-10 max-w-2xl mx-auto text-center">
          ...
          <h1 className="font-serif text-5xl md:text-6xl text-white mb-6">Intake Forms</h1>
          <p className="font-sans text-xl text-white/85 leading-relaxed mb-10">Smart forms that capture, qualify, and route every lead automatically. No missed submissions.</p>
          <div className="flex flex-col items-center gap-6">
            ...
            <Link to="/intake" className="font-sans text-white/65 text-sm hover:text-gold transition-colors">Back</Link>
          </div>
        </div>
      </section>
    </div>
