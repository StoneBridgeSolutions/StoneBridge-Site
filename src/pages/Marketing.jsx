    ...
    <div className="min-h-screen bg-gradient-to-b from-charcoal to-navy flex items-center justify-center px-6 py-20">
      <div className="max-w-2xl mx-auto text-center">
        ...
        <p className="text-xl text-gray-300 mb-4">
          Supercharge your business growth with automated marketing tools built for service businesses.
        </p>
        <p className="text-gray-400 mb-10">
          Social media management, email newsletters, blog automation, push notifications, and more &mdash; all in one place. Launching soon.
        </p>
