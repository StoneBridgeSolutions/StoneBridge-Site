    ...
    <div className="bg-navy min-h-screen pt-20 flex flex-col">
      <section className="grain-overlay relative flex-1 flex items-center justify-center px-6 py-24 overflow-hidden">
        ...
        <div className="relative z-10 max-w-2xl mx-auto text-center">
          ...
          <h1 className="font-serif text-5xl md:text-6xl text-white mb-6">Push Notifications</h1>
          <p className="font-sans text-xl text-white/85 leading-relaxed mb-10">Reach your customers directly on their phones with targeted messages and promotions.</p>
